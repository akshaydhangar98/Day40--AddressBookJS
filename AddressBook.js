...
function countContacts(contactArray){
 ...
 function addContact(addressBookArray,firstName,lastName){
    if(addressBookArray.find((contact)=>(contact.firstName+" "+contact.lastName)==(firstName+" "+lastName))){   
        ...
        try{
            addressBookArray.push(new Contact(Parag,Nile,'Jalgaon','Jalgaon','Maharashtra',425001,'91 7875211903','parag@gmail.com'));
...
try {
    addressBookArray.push(new Contact("Akshay", "Dhangar","Jalgaon", "Jalgaon", 'Maharastra', 425001, '91 7875211903', "abc@gmail.com"));
} catch (e) {
    console.log(e);
}
